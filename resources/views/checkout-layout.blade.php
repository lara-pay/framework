...
<div>
    ...
    <div class="relative mx-auto grid max-w-7xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8 lg:pt-16">
        ...
        <section aria-labelledby="summary-heading" class="bg-black py-12 text-indigo-300 md:px-10 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:w-full lg:max-w-lg lg:bg-transparent lg:px-0 lg:pb-24 lg:pt-0">
            <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
                ...
                <ul role="list" class="divide-y divide-white/10 text-sm font-medium">
                    <li class="flex items-start space-x-4 py-6">
                        <img src="https://tailwindui.com/plus-assets/img/ecommerce-images/checkout-page-07-product-01.jpg" alt="Front of zip tote bag with white canvas, white handles, and black drawstring top." class="size-20 flex-none rounded-md object-cover">
